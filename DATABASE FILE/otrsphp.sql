...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2024 at 07:53 PM
...
(1, 'MASH', 30, 15),
(2, 'GUARDIAN ANGEL', 20, 50),
(3, 'NAIROBI BUS', 10, 70),
(7, 'ELDORET EXPRESS', 14, 70),
(8, 'KINANGOP', 5, 15),
(9, 'KISUMU TOURS', 14, 55),
(10, 'Venice Express', 5, 70),
(11, 'Orient Express', 1, 70),
(12, 'Phantom Express', 5, 70),
(13, 'Marshland Express', 5, 70);
...
CREATE TABLE `feedback` (
  ...
  `response` varchar(14) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 3, 'This is a demo', NULL),
(3, 6, 'Demo Test - 2', 'Are you sure t'),
(8, 4, 'This is a feed', NULL),
(9, 6, 'Test Test Test', NULL),
(11, 8, 'This is a demo', 'none');
...
(1, 'Passenger One', 'pas1o@mail.com', '1f87051e29a6927b2e6651dfb9b66387', '07807000', 'No. 20 Aiyeteju Street', 'f3fc8566140434f0a3f47303c62d5146.jpg', 1),
...
(3, 'Passenger Two', 'pass2@mail.com', 'c3a19571f1271af5f27a9582377b7d4a', '114000020', 'abrahamjasmine', 'f3fc8566140434f0a3f47303c62d5146.jpg', 0),
(4, 'Passenger Three', 'pass3@mail.com', '1dd76b458af8df200a097c5b061df9b1', '90000070', 'No. 589 Ilorin', 'f3fc8566140434f0a3f47303c62d5146.jpg', 1),
...
(8, 'Demo Account', 'demoaccount@mail.com', '5f4dcc3b5aa765d61d8327deb882cf99', '7800000000', '100 Demo Address', '404a6378027a553d980b99162a5b4ce8.png', 0);
...
(1, 'foxhtro@gmail.com', '$2y$10$AYAWiHe/CK3csxs1CE0QwuLXt1vRmXx4H0hhFl6FpbYFVyCQ5OyE2');
